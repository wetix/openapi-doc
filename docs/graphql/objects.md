...
| `movie`              | [CinemaMovie!](/docs/graphql/objects#cinemamovie)                     | Look up a movie screened by the cinema using its key. **Arguments:** <br/>`key` : [Key!](docs/scalars#key) - An unique identifier for this object.                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `images`            | [[URI!]!](/docs/graphql/scalars#uri)                                        | The images related to the movie.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ~~`comments`~~      | ~~[MovieCommentConnection!](/docs/graphql/objects#moviecommentconnection)~~ | The movie comments. **(Upcoming Feature)**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `cinema`            | [MovieCinema!](/docs/graphql/objects#moviecinema)                           | Look up a cinema screening this movie using its key. <br/> **Arguments** <br/> `key` : [Key](/docs/graphql/sca;ars#key) - The cinema key.                                                                                                                                                                                                                                                                                                                                                                                       |
